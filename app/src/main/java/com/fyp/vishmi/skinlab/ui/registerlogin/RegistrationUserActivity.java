    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(RegistrationUserActivity.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        btn_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pw_re = et_pw_re.getText().toString().trim();

                if (!fullName.isEmpty() && !email.isEmpty() || !dob.isEmpty() || !pw.isEmpty() || !pw_re.isEmpty()) {
                    ...
                    if (pw.equals(pw_re)) {
                        ...
                        showSnackMSG(cl_main, "Password did not match...");
                    }
